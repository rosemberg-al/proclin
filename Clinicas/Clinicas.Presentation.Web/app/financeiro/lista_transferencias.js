(function () {
    ...
    Transferencias.$inject = ['$scope', '$http', '$q', '$modal', 'DTOptionsBuilder', 'blockUI', 'common', 'notification', 'exception', 'ds.financeiro', '$stateParams'];
    function Transferencias($scope, $http, $q, $modal, DTOptionsBuilder, blockUI, common, notification, exception, dsFinanceiro, $stateParams) {
        var vm = this;
        vm.titulo = "Transferências entre contas";
