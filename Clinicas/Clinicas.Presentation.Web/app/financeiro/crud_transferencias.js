(function () {
    ...
    CrudTransferencias.$inject = ['$scope', '$state', '$http', '$q', '$http', '$modal', '$modalInstance', 'blockUI', 'common', 'notification', 'exception', 'ds.financeiro', 'id'];
    function CrudTransferencias($scope, $state, $http, $q, $modal, $modalInstance, blockUI, common, notification, exception, dsFinanceiro, id) {
        var vm = this;
        ...
        function save() {
            ...
            var formvalido = common.validateForm($scope.forms.transferencias);
