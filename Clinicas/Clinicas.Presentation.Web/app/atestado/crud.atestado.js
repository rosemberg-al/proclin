(function () {
    ...
    AtestadoCrud.$inject = ['$scope', '$http', '$q', '$modal', '$modalInstance', 'blockUI', 'textAngularManager', 'common', 'notification', 'exception', 'DTInstances', 'ds.atestado', 'ds.funcionario', 'paciente', 'id'];

    function AtestadoCrud($scope, $http, $q, $modal, $modalInstance, blockUI, textAngularManager, common, notification, exception, DTInstances, dsAtestado, dsFuncionario, paciente, id) {
        ...
        function init() {
            ...
            var pModelos = dsAtestado.getModelosAtestados();
                ...
                if (id > 0) {
                    ...
                    dsAtestado
                        ...
                        .then(function (result) {
                            ...
                            //var modelo = _.find(vm.modelosatestados, { IdModeloProntuario: vm.atestado.IdModeloProntuario });
                            //vm.modeloSelecionado = modelo.IdModeloProntuario;
        ...
        function save() {
            ...
            vm.formValid = common.validateForm($scope.forms.atestado);
