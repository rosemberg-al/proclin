(function () {
    ...
    AusenciaController.$inject = ['$scope', '$http', '$q', '$modal', 'DTOptionsBuilder', 'blockUI', 'common', 'notification', 'exception', 'agendaservice'];

    function AusenciaController($scope, $http, $q, $modal, DTOptionsBuilder, blockUI, common, notification, exception, agendaservice) {
