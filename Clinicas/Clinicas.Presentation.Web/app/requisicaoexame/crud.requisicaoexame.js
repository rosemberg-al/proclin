(function () {
    ...
    RequisicaoExame.$inject = ['$scope', '$http', '$q', '$modal', '$modalInstance', 'blockUI', 'common', 'notification', 'exception', 'ds.funcionario', 'ds.prontuario', 'paciente', 'id'];

    function RequisicaoExame($scope, $http, $q, $modal, $modalInstance, blockUI, common, notification, exception, dsFuncionario, dsProntuario, paciente, id) {
        ...
        function init() {
            ...
            var pMedicos = dsFuncionario.listarMedicos();
        ...
        function save() {
            ...
            vm.formValid = common.validateForm($scope.forms.requisicao);
