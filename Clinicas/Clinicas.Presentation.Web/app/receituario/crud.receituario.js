(function () {
    ...
    angular
        .module('app.receituario')
        .controller('ReceituarioCrud', ReceituarioCrud);

    ReceituarioCrud.$inject = ['$scope', '$http', '$q', '$modal', '$modalInstance', 'blockUI', 'common', 'notification', 'exception', 'ds.funcionario', 'ds.receituario', 'paciente', 'id'];

    function ReceituarioCrud($scope, $http, $q, $modal, $modalInstance, blockUI, common, notification, exception, dsFuncionario, dsReceituario, paciente, id) {
        ...
        function init() {
            ...
            var pModelos = dsReceituario.getModelosReceituarios();
        ...
        function save() {
            ...
            vm.formValid = common.validateForm($scope.forms.receituario);
