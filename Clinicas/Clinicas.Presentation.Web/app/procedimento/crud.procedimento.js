(function () {
    ...
    ProcedimentoCrud.$inject = ['$scope', '$http', '$modal', '$modalInstance', 'blockUI', 'common', 'notification', 'exception', 'ds.cadastros', 'id'];

    function ProcedimentoCrud($scope, $http, $modal, $modalInstance, blockUI, common, notification, exception, dsCadastros, id) {
        ...
        function save() {
            ...
            vm.formValid = common.validateForm($scope.forms.proc);
