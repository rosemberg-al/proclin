...
d[c]=e,"o"===b[1]&&Y(a[e])});a._hungarianMap=d}function J(a,b,c){a._hungarianMap||Y(a);var d;h.each(b,function(e){d=a._hungarianMap[e];if(d!==k&&(c||b[d]===k))"o"===d.charAt(0)?(b[d]||(b[d]={}),h.extend(!0,b[d],b[e]),J(a[d],b[d],c)):b[d]=b[e]})}function Fa(a){var b=m.defaults.oLanguage,c=a.sZeroRecords;!a.sEmptyTable&&(c&&"Nenhum registro encontrado"===b.sEmptyTable)&&F(a,a,"sZeroRecords","sEmptyTable");!a.sLoadingRecords&&(c&&"Loading..."===b.sLoadingRecords)&&F(a,a,"sZeroRecords","sLoadingRecords");
...
sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Primeiro",sLast:"Último",sNext:"Próximo",sPrevious:"Anterior"},sEmptyTable:"Nenhum registro encontrado",sInfo:"Exibindo _START_ até _END_ de _TOTAL_ registros",sInfoEmpty:"Mostrando de 0 ate 0 de 0 registros",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Exibir_MENU_ registros",sLoadingRecords:"Carregando...",sProcessing:"Carregando...",sSearch:"Buscar:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Nenhum Registro Encontrado"},
