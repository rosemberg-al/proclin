(function () {
    ...
    angular
        .module('app.paciente')
        .controller('Listarpaciente', Listarpaciente);

    Listarpaciente.$inject = ['$scope', '$http', '$q', '$modal', 'DTOptionsBuilder', 'blockUI', 'common', 'notification', 'pacienteservice'];

    function Listarpaciente($scope, $http, $q, $modal, DTOptionsBuilder, blockUI, common, notification, pacienteservice) {
