(function () {
    ...
    CidCrud.$inject = ['$scope', '$http', '$modal', '$modalInstance', 'blockUI', 'common', 'notification', 'cadastroservice', 'codigo'];

    function CidCrud($scope, $http, $modal, $modalInstance, blockUI, common, notification, cadastroservice, codigo) {
            ...
            if ($scope.forms.crudcid.$valid) {
                ...
                cadastroservice
                    ...
                    .then(function (result) {
                        vm.cid = result.data;
                        if (codigo == "")
                            notification.showSuccess("CID cadastrado com sucesso!");
                        else
                            notification.showSuccess("CID alterado com sucesso!");
