(function () {
    ...
    RegistroVacina.$inject = ['$scope', '$http', '$q', '$modal', '$modalInstance', 'blockUI', 'common', 'notification', 'DTInstances', 'atendimentoservice', 'paciente', 'id'];

    function RegistroVacina($scope, $http, $q, $modal, $modalInstance, blockUI, common, notification, DTInstances, atendimentoservice, paciente, id) {
        ...
        function init() {
            ...
            var pVacinas = atendimentoservice.getVacinasAtivas();
