(function () {
    ...
    GuiaConsultaCrud.$inject = ['$scope', '$http', '$q', '$modal', '$modalInstance', 'blockUI', 'common', 'notification', 'pacienteservice', 'guiaservice', 'comumservice', 'id'];

    function GuiaConsultaCrud($scope, $http, $q, $modal, $modalInstance, blockUI, common, notification, pacienteservice, guiaservice, comumservice, id) {
