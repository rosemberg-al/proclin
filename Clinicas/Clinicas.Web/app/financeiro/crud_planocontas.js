(function () {
    ...
    CrudPlanoContas.$inject = ['$scope', '$http', '$modal', '$modalInstance', 'blockUI', 'common', 'notification', 'financeiroservice', 'id'];

    function CrudPlanoContas($scope, $http, $modal, $modalInstance, blockUI, common, notification, financeiroservice, id) {
