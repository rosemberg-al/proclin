(function () {
    ...
    angular
        ...
        .controller('ControllerModeloCrud', ControllerModeloCrud);

    ControllerModeloCrud.$inject = ['$scope', '$http', '$q', '$modal', '$modalInstance', 'blockUI', 'textAngularManager', 'common', 'notification', 'DTInstances', 'prontuarioservice', 'id'];

    function ControllerModeloCrud($scope, $http, $q, $modal, $modalInstance, blockUI, textAngularManager, common, notification, DTInstances, prontuarioservice, id) {
